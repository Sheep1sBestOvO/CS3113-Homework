...
const char PLAYER_SPRITE_FILEPATH[] = "sprite/sonic.png",
           FRAME_SPRITE_FILEPATH[]  = "sprite/frame.png",
           FONT_SPRITE_FILEPATH[]   = "sprite/font1.png";
...
// ———— PART 1 ———— //
bool g_s_key_pressed = false;
const int SPRITESHEET_DIMENSIONS = 4;
const int SECONDS_PER_FRAME = 8;
        ...
        switch (event.type) {
            ...
            case SDL_KEYDOWN:
                switch (event.key.keysym.sym) {
                    ...
                    // ———— PART 2 ———— //
                    case SDLK_s:
                        g_s_key_pressed = !g_s_key_pressed;
